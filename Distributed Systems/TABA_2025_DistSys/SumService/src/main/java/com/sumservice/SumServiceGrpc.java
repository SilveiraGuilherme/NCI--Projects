...
public final class SumServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sumservice.SumRequest,
      com.sumservice.SumResponse> getSumArrayMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SumArray",
      requestType = com.sumservice.SumRequest.class,
      responseType = com.sumservice.SumResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sumservice.SumRequest,
      com.sumservice.SumResponse> getSumArrayMethod() {
    io.grpc.MethodDescriptor<com.sumservice.SumRequest, com.sumservice.SumResponse> getSumArrayMethod;
    if ((getSumArrayMethod = SumServiceGrpc.getSumArrayMethod) == null) {
      synchronized (SumServiceGrpc.class) {
        if ((getSumArrayMethod = SumServiceGrpc.getSumArrayMethod) == null) {
          SumServiceGrpc.getSumArrayMethod = getSumArrayMethod =
              io.grpc.MethodDescriptor.<com.sumservice.SumRequest, com.sumservice.SumResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SumArray"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sumservice.SumRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sumservice.SumResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SumServiceMethodDescriptorSupplier("SumArray"))
              .build();
        }
      }
    }
    return getSumArrayMethod;
  }
  ...
  public static abstract class SumServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sumArray(com.sumservice.SumRequest request,
        io.grpc.stub.StreamObserver<com.sumservice.SumResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSumArrayMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.sumservice.SumRequest,
                com.sumservice.SumResponse>(
                  this, METHODID_SUM_ARRAY)))
          .build();
    }
  }
  ...
  public static final class SumServiceStub extends io.grpc.stub.AbstractAsyncStub<SumServiceStub> {
    ...
    public void sumArray(com.sumservice.SumRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getSumArrayMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class SumServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SumServiceBlockingStub> {
    ...
    /**
     */
    public com.sumservice.SumResponse sumArray(com.sumservice.SumRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getSumArrayMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class SumServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SumServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sumservice.SumResponse> sumArray(
        com.sumservice.SumRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getSumArrayMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SUM_ARRAY = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUM_ARRAY:
          serviceImpl.sumArray((com.sumservice.SumRequest) request,
              (io.grpc.stub.StreamObserver<com.sumservice.SumResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SumServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sumservice.SumServiceProto.getDescriptor();
    }
